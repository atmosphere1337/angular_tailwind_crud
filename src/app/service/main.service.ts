...
export class MainService {
  ...
  private Students: any = {
    '20-01': [
      {date: '20.09.2020', name: 'Алексеев Пётр'}, 
      {date: '10.09.2020', name: 'Андреев Андрей'}, 
      {date: '21.09.2020', name: 'Васильев Алесандр'}, 
      {date: '31.12.2019', name: 'Петров Петр'}, 
      {date: '12.12.2018', name: 'Денисов Денис'}, 
    ],
    '20-02': [
      {date: '23.09.2020', name: 'Владимир Владимиров'}, 
      {date: '13.09.2020', name: 'Анатолий Анатольев'}, 
      {date: '15.09.2021', name: 'Михаил Михайлов'}, 
    ],
    '19-03': [
